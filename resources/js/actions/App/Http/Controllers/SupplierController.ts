...
* @see app/Http/Controllers/SupplierController.php:14
* @route '/suppliers'
*/
...
* @see app/Http/Controllers/SupplierController.php:37
...
const SupplierController = { index, store, update, destroy }
