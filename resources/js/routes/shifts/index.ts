...
/**
* @see \App\Http\Controllers\ShiftController::cash
* @see app/Http/Controllers/ShiftController.php:61
* @route '/shifts/{shift}/cash'
*/
export const cash = (args: { shift: number | { id: number } } | [shift: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/shifts/{shift}/cash'
*/
cash.url = (args: { shift: number | { id: number } } | [shift: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { shift: args }
    }
...
* @route '/shifts/{shift}/cash'
*/
cash.post = (args: { shift: number | { id: number } } | [shift: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: cash.url(args, options),
    method: 'post',
})
...
* @route '/shifts/{shift}/cash'
*/
const cashForm = (args: { shift: number | { id: number } } | [shift: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/shifts/{shift}/cash'
*/
cashForm.post = (args: { shift: number | { id: number } } | [shift: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: cash.url(args, options),
    method: 'post',
})
